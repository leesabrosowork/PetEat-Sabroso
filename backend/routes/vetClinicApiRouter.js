...
router.put('/appointments/:id/approve', (req, res) => res.status(501).json({ success: false, message: 'Not implemented' }));
router.put('/appointments/:id/reject', (req, res) => res.status(501).json({ success: false, message: 'Not implemented' }));
// Inventory
