...
router.post('/pets', vetClinicController.addPet);
...
router.delete('/prescriptions/:id', vetClinicController.deletePrescription);
...
router.patch('/inventory/:id/stock', vetClinicController.updateInventoryStock);

// Activity feed
router.get('/activity-feed', activityController.getRecentActivities);
