...
async function resetAndSeed() {
    try {
        ...
        // 3. Insert one super admin
        const superAdmin = await SuperAdmin.create({
            username: 'superadmin',
            email: 'superadmin@PetEat.com',
        ...
        console.log('\nCredentials:');
        console.log('Super Admin:', { email: 'superadmin@PetEat.com', password: 'superadmin123' });
